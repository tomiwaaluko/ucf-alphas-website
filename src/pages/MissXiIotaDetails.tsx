          ...
          >
            ...
            <div className="max-w-6xl mx-auto px-4">
              ...
              <div className="text-center mb-16">
                ...
                >
                  Miss Xi Iota {currentMissXiIota.year}
                </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-gray-400">
                        Hometown: {currentMissXiIota.hometown}
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="grid gap-4">
                      {currentMissXiIota.achievements.map(
                        (achievement, index) => (
                          <motion.div
                            key={index}
            ...
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              >
                <motion.h2
                  ...
                  viewport={{ once: true }}
                >
                  Inspired by {currentMissXiIota.name}?
                </motion.h2>
...
export default MissXiIotaDetails;
