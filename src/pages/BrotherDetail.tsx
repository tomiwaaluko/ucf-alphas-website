...
const BrotherDetail = () => {
  ...
  const brotherData: { [key: string]: BrotherData } = {
    ...
    "5": {
      ...
      bio: "Jacob Herrera grew up in a military household with a father who served 26 years in the military. He grew up knowing nothing more than to search for the greatest extent of his capabilities and mind, pushing himself to be the best he could be.\n\nIn his upbringing, life was not necessarily what others would consider a normal environment for children, but he is beyond grateful for what it has shaped him into as a son, brother, and man. He spent his time very actively playing multiple sports, working out, and achieving high scholastic standings wherever he was, whether in high school or college.\n\nJacob fed and pursued his automotive passion in high school by receiving his first car from his parents and performing manual labor, molding it to his imagination and desires. He has done work on the mechanical components, suspension system, and body of the car. His first car propelled him to continue pursuing a career in the automotive industry in college, where he is now pursuing a mechanical engineering degree.",
      major: "Mechanical Engineering",
      year: "Junior",
      hometown: "Navarre, FL",
      interests: [
        "All things automotive and fitness related",
        "Expanding into the investing world",
      ],
      linkedin: "https://www.linkedin.com/in/jacob-herrera-5528012b7",
      email: "Ja603422@ucf.edu",
      achievements: ["Dedicated scholar"],
      quote:
        "The question isn't who is going to let me; it's who is going to stop me.",
      organizations: ["NSBE", "Knights Racing (Formula SAE)"],
    },
    "6": {
      name: "Adams Brown Jr.",
      crossingSemester: "Fall 2024",
    ...
    "12": {
      ...
      position: "Active Member",
      image: "/brothers/Ralph Volny.png",
      bio: "I am a Finance major at the University of central Florida. I am family oriented and they are my strength. I look to live an active lifestyle. After undergrad I wish to continue my educational journey by going to law school.",
      major: "Finance",
      year: "Senior",
      hometown: "Naples, FL",
      interests: ["Sports", "Reading", "Singing"],
      linkedin: "https://www.linkedin.com/in/ralph-volny",
      email: "Ra418349@ucf.edu",
      achievements: ["Dean's List"],
      quote: "Believe you can, you're halfway there. — Theodore Roosevelt",
      organizations: ["Alpha Phi Alpha", "Gospel and Cultural Choir"],
    },
    "13": {
      name: "Marquise Williamson",
      crossingSemester: "Fall 2025",
      position: "Active Member",
      image: "/brothers/Marquise  Williamson.png",
      bio: "I'm a determined and hardworking individual who takes pride in getting the job done well. Discipline is one of my biggest strengths, and I'm someone people know they can trust and rely on. Outside of work, I enjoy fishing and spending time with friends as it keeps me grounded and motivated. Overall, I bring a strong work ethic, consistency, and a positive attitude to everything I do.",
      major: "Biology Pre-Health",
      year: "Senior",
      hometown: "Miami, FL",
      interests: ["Fishing", "Spending time with friends"],
      linkedin: "https://www.linkedin.com/in/marquise-williamson-399568237",
      email: "ma674903@ucf.edu",
      achievements: ["Strong work ethic and discipline"],
    ...
    "14": {
      ...
      crossingSemester: "Fall 2025",
      position: "Active Member",
      image: "/brothers/Yan Morrison.png",
      bio: "Senior in Kinesiology with a minor and health services administration at the University of Central Florida. I am passionate about the intersection of patient care and healthcare operations, and I aspire to build a career in physical therapy and healthcare business management.",
      major: "Kinesiology / Health Services Administration",
      year: "Senior",
      hometown: "Fort Pierce, Florida",
      interests: ["Fitness"],
      linkedin: "https://www.linkedin.com/in/yan-morrison-179120273/",
      email: "Ya136896@ucf.edu",
      achievements: [
        "Fall '23 Presidents List",
        "Spring '24 Deans List",
        "Fall '24 Deans List",
        "Spring '25 Deans List",
      ],
      quote: "Hard Work Brings Success",
      organizations: [
        "BUKA",
        "Men of Integrity",
    ...
    "15": {
      ...
      crossingSemester: "Fall 2025",
      position: "Active Member",
      image: "/brothers/Noah Benoit.jpg",
      bio: "I am an Aerospace Engineering sophomore at the University of Central Florida. In the future, I'd like to have a specialization in space but right now I'd love to learn about the many facets of Aerospace. I am a member of the Excel/Compass program and a member of the Burnett Honors College at UCF. Outside of school, I enjoy spending time with friends, going to the gym, playing my guitar, and riding my bike.",
      major: "Aerospace Engineering",
      year: "Sophomore",
      hometown: "Miami, Florida",
      interests: ["Playing Bass Guitar", "Building Computers", "Gym", "Gaming"],
      linkedin: "https://www.linkedin.com/in/noah-benoit-",
      email: "no727925@ucf.edu",
      achievements: ["Burnett Honors College", "Excel/Compass Program"],
    ...
    "16": {
      ...
      year: "Senior",
      hometown: "Miami, FL",
      interests: ["Making Music", "Graphic Design", "Roller Skating"],
      linkedin: "https://www.linkedin.com/in/jaheim-golden-63ab15167",
      email: "ja092068@ucf.edu",
      achievements: [
        "Deans List Fall 2024",
        "Mr. Debonair - Mu Iota Chapter of Delta Sigma Theta Sorority, Inc.",
        "President of Progressive Black Men Inc",
        "Vice President of Black Men in Medicine",
        "Community Health Ambassador",
        "Social Media Ambassador",
      ],
      quote:
        "Success is to be measured not so much by the position that one has reached in life as by the obstacles which he has overcome.",
      organizations: ["Black Men in Medicine", "Progressive Black Men, Inc."],
    },
    "17": {
      name: "Da'Juan Thornton",
      crossingSemester: "Fall 2025",
      position: "Active Member",
      image: "/brothers/Dajuan Thornton.jpg",
      bio: "I am highly ambitious and career-driven, with a clear focus on building a strong foundation in finance and commercial banking. My professional goals center around becoming a financial analyst or commercial banker, where I can combine my analytical mindset with my passion for helping others make informed financial decisions. My entrepreneurial spirit is reflected in my creation of Goldstone Financials and my experience as a licensed life insurance agent with Symmetry Financial Group, where I've explored carriers like Mutual of Omaha and Foresters. My drive, professionalism, and commitment to continuous growth reflect my dedication to advancing in the financial industry and making a lasting impact through my work.",
      major: "Integrated Business",
      year: "Senior",
      hometown: "West Palm Beach, Florida",
      interests: ["Basketball"],
      linkedin: "https://www.linkedin.com/in/dajuanthornton16",
      email: "da321227@ucf.edu",
      achievements: [
        "Synchrony Externship",
        "Licensed Life Insurance Agent",
        "JP Morgan Internship",
        "Creator of Goldstone Financials",
      ],
      quote:
        "I can do all things through Christ who strengthens me. — Philippians 4:13",
      organizations: ["Alpha Kappa Psi Professional Business Fraternity"],
    },
  };
