  ...
  const brothers = [
    {
      ...
      achievements: ["Dean's List", "Tech Innovation Award", "Engineering Excellence"],
    ...
    },
    {
      ...
      achievements: ["Student Body President", "Entrepreneur of the Year", "Business Leadership"],
    ...
    },
    {
      ...
      lineNumber: "#3", 
      major: "Science",
      achievements: ["Research Excellence", "Academic Scholar", "Scientific Innovation"],
    ...
    },
    {
      ...
      achievements: ["Engineering Design Award", "Innovation Champion", "Technical Excellence"],
    ...
    },
    {
      ...
      lineNumber: "#5",
      major: "Mechanical Engineering",
      achievements: ["Engineering Excellence", "Project Leadership", "Technical Mentorship"],
    ...
    },
    {
      ...
      achievements: ["Business Strategy Award", "Financial Excellence", "Leadership Development"],
    ...
    },
    {
      ...
      lineNumber: "#7",
      major: "Kinesiology",
      achievements: ["Health & Wellness Advocate", "Athletic Excellence", "Community Health Leader"],
    ...
    },
    {
      ...
      achievements: ["Technology Innovation", "Digital Solutions", "IT Excellence"],
    ...
    },
    {
      ...
      achievements: ["Pre-Med Excellence", "Research Scholar", "Future Healthcare Leader"],
    ...
    },
    {
      ...
      lineNumber: "#10",
      major: "Biology",
      achievements: ["Scientific Research", "Academic Excellence", "Biology Innovation"],
          ...
          >
            ...
            <div className="max-w-6xl mx-auto px-4 text-center">
              ...
              >
                ...
                >
                  The brothers of Xi Iota Chapter represent excellence in scholarship, leadership, and service.
                  <br className="hidden sm:block" />
                  Our diverse membership includes students and professionals who are making a positive
                  <br className="hidden sm:block" />
            ...
            <div className="max-w-7xl mx-auto px-4">
              ...
              >
                ...
                <p className="text-xl text-gray-300">
                  Each brother brings unique talents and perspectives to our fraternal bond
                </p>
              </motion.div>
              
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {brothers.map((brother, index) => (                  <motion.div
                    key={brother.id}
            ...
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              >
                ...
                <motion.p
                  ...
                  viewport={{ once: true }}
                >
                  Our brotherhood extends beyond the university years, creating lifelong bonds and 
                  professional networks that span generations. Each brother contributes to a legacy 
                  of excellence, service, and leadership that continues to inspire future generations.
                </motion.p>
