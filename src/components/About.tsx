  ...
  const values = [
    {
      ...
      title: "Scholarship",
      description:
        "Promoting academic excellence and intellectual growth among our members and community.",
    },
    {
      icon: Users,
      title: "Brotherhood",
      description:
        "Building lifelong bonds of friendship, support, and mutual respect.",
    },
    {
      icon: Heart,
      title: "Service",
      description:
        "Dedicated to improving our communities through meaningful service and outreach.",
    },
    {
      icon: Award,
      title: "Leadership",
      description:
        "Developing leaders who will make positive impacts in their professions and communities.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Founded on the principles of scholarship, fellowship, good
            character, and the uplifting of humanity, the Xi Iota Chapter of
            Alpha Phi Alpha Fraternity, Inc. continues the proud tradition of
            excellence established by our founders at Cornell University in
            1906.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {values.map((value, index) => (
            <div key={index} className="text-center group">
              ...
              <h3 className="text-xl font-semibold mb-3 text-yellow-400 font-cinzel">
                {value.title}
              </h3>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black border border-yellow-400/20 rounded-2xl p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-3xl font-bold mb-6 text-yellow-400 font-cinzel">
                Our Mission
              </h3>{" "}
              <p className="text-gray-300 leading-relaxed mb-6">
                ...
                advocacy for our communities. We are committed to being{" "}
                <span className="font-crimson italic text-yellow-400">
