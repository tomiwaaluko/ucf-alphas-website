        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-10">
              <Link to="/" className="text-white hover:text-yellow-400 transition-colors duration-300 font-medium uppercase tracking-wider text-sm">
                Home
              </Link>
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-56 bg-black/95 backdrop-blur-sm border border-yellow-400/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                  <Link to="/fraternity-history" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Fraternity History</Link>
                  <Link to="/meet-the-jewels" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Meet the Jewels</Link>
                  <Link to="/national-programs" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">National Programs</Link>
                  <Link to="/poems" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Poems</Link>
                  <Link to="/become-an-alpha" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Become An Alpha</Link>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-56 bg-black/95 backdrop-blur-sm border border-yellow-400/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                  <Link to="/chapter-history" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Chapter History</Link>
                  <Link to="/leadership" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Leadership</Link>
                  <Link to="/meet-the-brothers" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Meet the Brothers</Link>
                  <Link to="/lineage" className="block px-6 py-3 text-white hover:text-yellow-400 hover:bg-yellow-400/10 transition-colors duration-200 font-medium">Lineage</Link>
                </div>
              </div>

              <Link to="/miss-black-and-gold" className="text-white hover:text-yellow-400 transition-colors duration-300 font-medium uppercase tracking-wider text-sm">
                Miss Black and Gold
              </Link>
              <Link to="/service" className="text-white hover:text-yellow-400 transition-colors duration-300 font-medium uppercase tracking-wider text-sm">
                Service
              </Link>
              <button onClick={() => scrollToSection('contact')} className="text-white hover:text-yellow-400 transition-colors duration-300 font-medium uppercase tracking-wider text-sm">
                Contact
              </button>
            </div>
          </div>
